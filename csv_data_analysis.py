...
indx_max = np.argmax(a[:,3])
print("Roll no who got maximum marks in Subject 3", (a[indx_max,0]))

# 14. print Roll number who got minimum marks in Subject 2
indx_min = np.argmin(a[:,2])
print("Roll no who got minimum marks in Subject 2",a[indx_min,0])
